...
export default {
  footer: {
    ...
    profile: {
      title: 'Work With Us',
      url: `${baseUrlWithLanguage}/companies/778589-jobstreet`
    },
    terms: {
      title: 'Term of Use',
  ...
  header: {
    ...
    login: {
      title: 'Log in',
      url: {
        home: 'https://myjobstreet.jobstreet.co.id/home/login.php?site=id&language_code=3',
        jobListing: 'https://myjobstreet.jobstreet.co.id/home/login.php?site=id&language_code=3&go=JOB-LISTING&nrfr=1',
        jobAd: 'https://myjobstreet.jobstreet.co.id/home/login.php?site=id&language_code=3&go=JOB-ADS&nrfr=1'
      }
    },
